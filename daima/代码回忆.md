...
隐含条件，另一半apLineup[1-min]大于apLineup[min]，pair[0]<pair[1]。apLineup[min]的pair中，apLineup[min]可能位于pair[0]也可能位于pair[1]，这里千万要注意，min是指传进来的apLineup，而不是pair中的min，不要搞混了。
