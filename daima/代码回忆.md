...
对于我来说，最终我做出来的军棋ai强不强不重要，但是它不能像大模型一样犯很多基础逻辑的判断错误，它可以笨，但它需要有足够的理性能讲清楚自己的思路。
