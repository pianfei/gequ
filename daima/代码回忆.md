...
pPair新建后两个lineup都插的，并不是只插小的，查询的时候选择小的。
min是1，id是100，找100的pair，在100的pair中另一半可能比100大也可能比100小，但u.pPair->apLineup[0]必须比u.pPair->apLineup[1]小。如果apLineup[1-min]和p->u.pPair->apLineup[1]（较大的，可能是apLineup[min]也可能不是）对上，在小的里面找，如果大的一样说明找到了。
